...
local old_click = CoreGui:FindFirstChild('AXEN')

if old_click then
    Debris:AddItem(old_click, 0)
end

if not isfolder("AXEN") then
    makefolder("AXEN")
end
...
local Config = setmetatable({
    save = function(self: any, file_name: any, config: any)
        local success_save, result = pcall(function()
            ...
            writefile('AXEN/'..file_name..'.json', flags)
        end)
    ...
    load = function(self: any, file_name: any, config: any)
        local success_load, result = pcall(function()
            if not isfile('AXEN/'..file_name..'.json') then
                self:save(file_name, config)
        
                return
            end
        
            local flags = readfile('AXEN/'..file_name..'.json')
...
NotificationContainer.Position = UDim2.new(0.6, 0, 0, 10)  
...
function Library.SendNotification(settings)
    ...
    InnerFrame.Position = UDim2.new(0, slideOffset, 0, 0)
    InnerFrame.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
    ...
    Body.Text = text
    Body.TextColor3 = Color3.fromRGB(68, 68, 153)
    Body.FontFace = Font.new('rbxasset://fonts/families/GothamSSm.json', Enum.FontWeight.Regular, Enum.FontStyle.Normal)
    Body.TextSize = 12
    Body.Size = UDim2.new(1, -30, 0, 30)
    ...
    CloseButton.Text = "X"
    CloseButton.TextColor3 = Color3.fromRGB(68, 68, 153)
...
function Library:create_ui()
    ...
    Container.BorderColor3 = Color3.fromRGB(8, 8, 51)
    Container.AnchorPoint = Vector2.new(0.5, 0.5)
    Container.Name = 'Container'
    Container.BackgroundTransparency = 0.05
    Container.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
    ...
    UIStroke.Color = Color3.fromRGB(8, 8, 51)
    ...
    Handler.BorderColor3 = Color3.fromRGB(8, 8, 51)
    ...
    Tabs.BorderColor3 = Color3.fromRGB(8, 8, 51)
...
local UIStroke = Instance.new('UIStroke')
UIStroke.Color = Color3.fromRGB(68, 68, 153)
UIStroke.Thickness = 1
UIStroke.Parent = ClientName

local spinChars = {"/", "-", "\\", "|"}
local i = 1
task.spawn(function()
while true do
ClientName.Text = " AXEN " .. spinChars[i] .. " " .. os.date("%I:%M:%S %p")
i = i % #spinChars + 1
task.wait(0.2)
end
end)
...
ClientName.BorderColor3 = Color3.fromRGB(8, 8, 51)
...
ClientName.Parent = Handler
    ...
    Pin.BorderColor3 = Color3.fromRGB(8, 8, 51)
    Pin.Size = UDim2.new(0, 2, 0, 16)
    Pin.BorderSizePixel = 0
    Pin.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
    Pin.Parent = Handler
    ...
    Icon.ImageColor3 = Color3.fromRGB(68, 68, 153)
    Icon.ScaleType = Enum.ScaleType.Fit
    Icon.BorderColor3 = Color3.fromRGB(8, 8, 51)
    Icon.AnchorPoint = Vector2.new(0, 0.5)
    Icon.Image = 'rbxassetid://6031091009'
    ...
    Divider.BorderColor3 = Color3.fromRGB(8, 8, 51)
    Divider.Size = UDim2.new(0, 1, 0, 479)
    Divider.BorderSizePixel = 0
    Divider.BackgroundColor3 = Color3.fromRGB(51, 51, 128)
    ...
    Minimize.TextColor3 = Color3.fromRGB(8, 8, 51)
    Minimize.BorderColor3 = Color3.fromRGB(8, 8, 51)
    Minimize.Text = ''
    ...
    ToggleUI.TextColor3 = Color3.fromRGB(8, 8, 51)
    ToggleUI.BorderColor3 = Color3.fromRGB(8, 8, 51)
    ToggleUI.Text = ''
    ...
    ToggleUI.Size = UDim2.new(0, 24, 0, 24)
    ToggleUI.BorderSizePixel = 0
    ToggleUI.TextSize = 14
    ToggleUI.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ToggleUI.Parent = Handler

    local ToggleIcon = Instance.new('ImageLabel')
    ToggleIcon.ImageColor3 = Color3.fromRGB(68, 68, 153)
    ToggleIcon.ScaleType = Enum.ScaleType.Fit
    ToggleIcon.BorderColor3 = Color3.fromRGB(8, 8, 51)
    ToggleIcon.AnchorPoint = Vector2.new(0.5, 0.5)
    ToggleIcon.Image = 'rbxassetid://6035047679'
            ...
            if object == tab then
                if object.BackgroundTransparency ~= 0.5 then
                    ...
                    TweenService:Create(object.TextLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        ...
                        TextColor3 = Color3.fromRGB(68, 68, 153)
                    }):Play()
                    ...
                    TweenService:Create(object.Icon, TweenInfo.new(3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        ...
                        ImageColor3 = Color3.fromRGB(68, 68, 153)
                    }):Play()
                end
    ...
    function self:create_tab(title: string, icon: string)
        ...
        Tab.TextColor3 = Color3.fromRGB(8, 8, 51)
        Tab.BorderColor3 = Color3.fromRGB(8, 8, 51)
        Tab.Text = ''
        ...
        Tab.TextSize = 14
        Tab.BackgroundColor3 = Color3.fromRGB(51, 51, 128)
        Tab.Parent = Tabs
        ...
        TextLabel.BorderColor3 = Color3.fromRGB(8, 8, 51)
        ...
        UIGradient.Color = ColorSequence.new{
            ...
            ColorSequenceKeypoint.new(0.7, Color3.fromRGB(68, 68, 153)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(8, 8, 51))
        }
        ...
        LeftSection.BorderColor3 = Color3.fromRGB(8, 8, 51)
        ...
        RightSection.BorderColor3 = Color3.fromRGB(8, 8, 51)
        ...
        function TabManager:create_module(settings: any)
            ...
            local UIStroke = Instance.new('UIStroke')
            UIStroke.Color = Color3.fromRGB(51, 51, 128)
            UIStroke.Transparency = 0.5
            UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
            ...
            Header.TextColor3 = Color3.fromRGB(8, 8, 51)
            Header.BorderColor3 = Color3.fromRGB(8, 8, 51)
            Header.Text = ''
            ...
            ModuleName.TextColor3 = Color3.fromRGB(68, 68, 153)
            ModuleName.TextTransparency = 0.20000000298023224
            if not settings.rich then
                ModuleName.Text = settings.title or "Skibidi"
            else
                ModuleName.RichText = true
                ModuleName.Text = settings.richtext or "<font color='rgb(255,0,0)'>AXEN</font> user"
            end;
            ...
            ModuleName.BorderColor3 = Color3.fromRGB(8, 8, 51)
            ...
            Description.TextColor3 = Color3.fromRGB(68, 68, 153)
            ...
            Description.BorderColor3 = Color3.fromRGB(8, 8, 51)
            ...
            Toggle.BorderColor3 = Color3.fromRGB(8, 8, 51)
            Toggle.Size = UDim2.new(0, 25, 0, 12)
            Toggle.BorderSizePixel = 0
            Toggle.BackgroundColor3 = Color3.fromRGB(51, 51, 128)
            ...
            Circle.BorderColor3 = Color3.fromRGB(8, 8, 51)
            ...
            Circle.BackgroundColor3 = Color3.fromRGB(51, 51, 128)
            ...
            Keybind.BorderColor3 = Color3.fromRGB(8, 8, 51)
            Keybind.Size = UDim2.new(0, 33, 0, 15)
            Keybind.BorderSizePixel = 0
            Keybind.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
            ...
            Divider.BorderSizePixel = 0
            Divider.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
            ...
            Options.BorderColor3 = Color3.fromRGB(8, 8, 51)
            ...
            if Library:flag_type(settings.flag, 'boolean') then
                ...
                Toggle.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
                Circle.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
            ...
            function ModuleManager:create_paragraph(settings: any)
                ...
                Paragraph.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
                ...
                if not settings.rich then
                    ...
                    Body.RichText = true
                    Body.Text = settings.richtext or "<font color='rgb(255,0,0)'>AXEN</font> user"
                end
                ...
                Paragraph.MouseEnter:Connect(function()
                    TweenService:Create(Paragraph, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
                        BackgroundColor3 = Color3.fromRGB(8, 8, 51)
                    }):Play()
                end)
            ...
            function ModuleManager:create_text(settings: any)
                ...
                TextFrame.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
                ...
                function TextManager:Set(new_settings)
                    if not new_settings.rich then
                        ...
                        Body.RichText = true
                        Body.Text = new_settings.richtext or "<font color='rgb(255,0,0)'>AXEN</font> user"
                    end
                end;
            ...
            function ModuleManager:create_textbox(settings: any)
                ...
                Textbox.BorderColor3 = Color3.fromRGB(8, 8, 51)
                ...
                Textbox.TextSize = 10
                Textbox.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
            ...
            function ModuleManager:create_checkbox(settings: any)
                ...
                Checkbox.TextColor3 = Color3.fromRGB(8, 8, 51)
                Checkbox.BorderColor3 = Color3.fromRGB(8, 8, 51)
                Checkbox.Text = ""
                ...
                Checkbox.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
                ...
                KeybindLabel.TextColor3 = Color3.fromRGB(8, 8, 51)
                ...
                Box.BorderColor3 = Color3.fromRGB(8, 8, 51)
                ...
                Box.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
                Box.Parent = Checkbox
                ...
                Fill.BorderColor3 = Color3.fromRGB(8, 8, 51)
                Fill.Name = "Fill"
                Fill.BorderSizePixel = 0
                Fill.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
                Fill.Parent = Box
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Slider.TextSize = 14;
                Slider.TextColor3 = Color3.fromRGB(8, 8, 51)
                Slider.BorderColor3 = Color3.fromRGB(8, 8, 51)
                Slider.Text = ''
                ...
                Slider.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
                ...
                Drag.BorderColor3 = Color3.fromRGB(8, 8, 51)
                ...
                Drag.BackgroundColor3 = Color3.fromRGB(68, 68, 153)
                Drag.Parent = Slider
                ...
                Value.BorderColor3 = Color3.fromRGB(8, 8, 51)
                Value.TextSize = 10
            ...
            function ModuleManager:create_dropdown(settings: any)
                ...
                Dropdown.TextColor3 = Color3.fromRGB(8, 8, 51)
                Dropdown.BorderColor3 = Color3.fromRGB(8, 8, 51)
                Dropdown.Text = ''
                ...
                Dropdown.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
                ...
                CurrentOption.BorderColor3 = Color3.fromRGB(8, 8, 51)
                ...
                Arrow.BorderColor3 = Color3.fromRGB(8, 8, 51)
                ...
                Options.ScrollBarImageColor3 = Color3.fromRGB(8, 8, 51)
                Options.Active = true
                ...
                if #settings.options > 0 then
                    ...
                    for index, value in settings.options do
                        ...
                        Option.BorderColor3 = Color3.fromRGB(8, 8, 51)
            ...
            function ModuleManager:create_feature(settings)
                ...
                FeatureButton.BackgroundColor3 = Color3.fromRGB(8, 8, 51)
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(68, 68, 153) or Color3.fromRGB(8, 8, 51)
                    Checkbox.Text = ""
    ...
    self._ui.Container.Handler.ToggleUI.MouseButton1Click:Connect(function()
        self:UIVisiblity()
    end)
...
AutoParry.IsCurved = function(ball)
    ...
    local curveSens = Library._config._flags["CurveSensitivity"] or 50
    local sensFactor = 0.5 + (curveSens / 100)

    local baseDotThreshold = 0.15 * sensFactor
    if Speed > 600 then
        baseDotThreshold = -0.1 * sensFactor
    ...
    local Dot_Threshold = baseDotThreshold - (GetAveragePing() / 2000) - (math.min(Speed / 4000, 0.1) * sensFactor)
...
local parriedBalls = {}
  ...
  -- Credits tab
local CreditsTab = main:create_tab("Credits ", "rbxassetid://6023565894")
local creditsModule = CreditsTab:create_module({
title = "Credits",
flag = "creditsModule",
...
creditsModule:create_paragraph({
title = "Aden",
text = "UI Designer & Feature Developer\nDesigned the entire interface and contributed to features."
})

creditsModule:create_paragraph({
title = "axom",
text = "Lead Feature Developer\nDeveloped core features including the dropdown system."
})

local discordModule = CreditsTab:create_module({
title = "Discord Servers",
flag = "discordModule",
description = "Click to copy invite links",
section = "right",
callback = function(v) end
})

discordModule:create_feature({
title = "ADEN SCRIPTS",
flag = "discordAden",
disablecheck = true,
button_callback = function()
setclipboard("https://discord.gg/YDXQeGwv82")
Library.SendNotification({
title = "Discord Link Copied",
text = "ADEN SCRIPTS invite copied to clipboard!",
duration = 3
})
end
})
...
disablecheck = true,
button_callback = function()
setclipboard("https://discord.gg/5j2zVgc3Hm")
Library.SendNotification({
title = "Discord Link Copied",
text = "AXOM SERVER invite copied to clipboard!",
duration = 3
})
end
})
          ...
          if v then
              ...
              Connections["autoParry"] = RunService.PreSimulation:Connect(function()
                  ...
                  for _, ball in pairs(balls) do
                      ...
                      local speedDivisor = speedDivisorBase * Speed_Divisor_Multiplier
                      local parryAccuracy = adjustedPing + math.max(speed / speedDivisor, 9.5)
                      local predictiveOffset = (Library._config._flags["PredictiveOffset"] or 0) / 1000
                      parryAccuracy = parryAccuracy + predictiveOffset
  ...
  autoParryModule:create_slider({
      title = "Predictive Offset (ms)",
      flag = "PredictiveOffset",
      maximum_value = 200,
      minimum_value = 0,
      value = 50,
      round_number = true,
